...
def main_function(concept_prereq_file, concept_wiki_data_file):
    df_prereq = pd.read_csv(concept_prereq_file, encoding = "utf-8")
    df_wiki = pd.read_csv(concept_wiki_data_file, encoding = "utf-8")

    df_estimated = get_prereq_relations(df_prereq, df_estimated)
    return df_estimated



concept_prereq_file = "../output_files/physics_labeled_pairs.csv"
concept_wiki_data_file = "../output_files/physics_correct_wikipedia_data.csv"

df_estimated = main_function(concept_prereq_file, concept_wiki_data_file)
