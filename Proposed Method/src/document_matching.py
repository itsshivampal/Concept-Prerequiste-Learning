...
def save_concept_resolve_data(data, output_file):
    columns = ["concept", "type", "index", "hr_index", "mc_index"]
...
def resolve_multi_sections(sections, concept):
    ...
    if len(sections) == 1:
        ...
        resulted_section = get_final_section_list(documents, section_combination, concept)
    ...
    # for i in range(10):
        ...
        if func_type == 1 or func_type == 2:
            ...
            if len(sections) > 1:
                ...
                mc_index = resolve_multi_sections(hr_index, concept)
